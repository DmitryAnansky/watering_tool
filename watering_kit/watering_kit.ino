...
//  Serial.println(moisture3_value);
  ...
  {
    if (moisture1_value < watering_magic_number)
    {
    ...
    else if (moisture1_value >= watering_magic_number)
    {
      digitalWrite(relay1, LOW);
      relay1_state_flag = 0;
      delay(50);
      if ((relay1_state_flag == 0) && (relay2_state_flag == 0) && (relay3_state_flag == 0))
      {
    ...
    if (moisture2_value < watering_magic_number)
    {
    ...
    else if (moisture2_value >= watering_magic_number)
    {
    ...
    if (moisture3_value < watering_magic_number)
    {
    ...
    else if (moisture3_value >= watering_magic_number)
    {
